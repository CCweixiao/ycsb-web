package com.leo.ycsb.job.executor.db;

import com.leo.ycsb.ByteArrayByteIterator;
import com.leo.ycsb.ByteIterator;
import com.leo.ycsb.DBException;
 ...
 */
public class HBaseClient extends com.leo.ycsb.DB{
        ...
        try {
            ...
            if (threadCount <= 0) {
                ...
                synchronized (THREAD_COUNT) {
                    if (connection != null) {
                        connection.close();
                        XxlJobHelper.log("the current connection of hbase is closed successfully.");
                        connection = null;
                    }
                }
            }
